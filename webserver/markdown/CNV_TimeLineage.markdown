...
Herein, in scSVAS platform, we develop a readily available web interface "CNV Time Lineage''  for interactive and real-time visualization of clonal lineage across time for scDNA-seq data.

"CNV Time Lineage'' enables users to create the time lineage visualization just in following steps:
