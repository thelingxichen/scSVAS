...
- **Tooltips**
  ...
  + __*Point*__: Chromosome number, pointed position of chromosome and average copy number of the pointed position.
- **Download**
...
- **Files**
  ...
  + __*Choose*__: choose files uploaded previously. Note that this function is ONLY available to registered user
  + __*File Sets*__: set current chosen files as a file set. Note that this function is ONLY available to registered user
- **Graph Fomation**
  + __*Width*__: width of graph can be altered.
  + __*Height*__: height of graph can be altered.
  + __*Stroke Width*__: stroke width of graph can be altered.
  + __*Vlaue Range*__: user can alter value range to see clearly how average copy number fluctuate.
  + __*Event Confidence*__: This option is for bed file. The platform will choose the relative segment and copy number based on event confidence to regenerate stairstep graph. 
  + __*Select File*__: provide interface switch between bed file and cnv file
