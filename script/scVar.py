...
def annotate_shifts(t, cnv_df, shift=0.5, target_gene_fn=None, ref='hg38'):
    ...
    for link in t.links:
        ...
        call_bedtool_bin2gene(amp_bins, ref, link=link, shift_type='amp')
        call_bedtool_bin2gene(loss_bins, ref, link=link, shift_type='loss')
...
def call_bedtool_bin2gene(bin_list, ref, use_db=True, **kwargs):
    ...
    gene_bed = anno.get_gene_bed(ref, use_db=use_db)
